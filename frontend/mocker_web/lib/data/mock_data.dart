class MockData {
  ...
  static Map<String, dynamic> userProfile = {
    ...
    'photoURL': '',
    'linkedinLink': 'https://www.linkedin.com/in/alexcarter/',
    'githubLink': 'https://github.com/hustlrzz',
  ...
  static Map<String, List<Map<String, dynamic>>> interviewChats = {
    'workflow_001': [
      ...
      },
      {
        'messageId': 'msg_002',
        'role': 'user',
        'message': 'Hi, I am Alex, a backend engineer with 3 years of experience.',
  ...
  static List<Map<String, dynamic>> interviewHistory = [
    {
      ...
      'transcript': [
        ...
        {
          'role': 'user',
          'content': 'Hi, I am Alex, a backend engineer with 3 years of experience in Python and Django.',
