...
RATE_FEEDBACK_PER_MIN = int(os.getenv("RATE_FEEDBACK_PER_MIN", "10"))
RATE_ANALYTICS_PER_MIN = int(os.getenv("RATE_ANALYTICS_PER_MIN", "30"))
RATE_DRILL_REVIEW_PER_MIN = int(os.getenv("RATE_DRILL_REVIEW_PER_MIN", "30"))
RATE_DELETE_PER_MIN = int(os.getenv("RATE_DELETE_PER_MIN", "20"))
