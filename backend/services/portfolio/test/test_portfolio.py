...
MOCK_DATA = {
    ...
    "github_link": "https://github.com/hustlrzz",
...
async def manual_real_portfolio_analysis():
...
async def manual_full_workflow_integration():
...
async def run_manual_tests():
    ...
    portfolio_success = await manual_real_portfolio_analysis()
    
    # Test workflow integration
    workflow_success = await manual_full_workflow_integration()
